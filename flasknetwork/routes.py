...
from flasknetwork import app, db, bcrypt, mail
from flasknetwork.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm
...
def update_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit() # no db.session.add() since post is already in the db
